package turkuvaz.general.turkuvazgeneralwidgets.HeadlineSliderWithTitle.Adapter;
...
public class HeadlineSliderTitleAdapter extends PagerAdapter {
    ...
    public HeadlineSliderTitleAdapter(Activity context, ArrayList<Article> response) {
        mResponse = response;
        mContext = context;
    }
    ...
    public Object instantiateItem(@NonNull ViewGroup collection, final int position) {
        ViewGroup layout = (ViewGroup) LayoutInflater.from(collection.getContext()).inflate(R.layout.headline_slider_with_title_item, collection, false);
        try {
            try {
